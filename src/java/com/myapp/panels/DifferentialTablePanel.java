 ...
 * @author Posudevskiy
 */
public final class DifferentialTablePanel extends Panel {
    ...
    public DifferentialTablePanel(String id) {
        super(id);

        imageBlockShow = new Image("image_block_show_diftable", new PackageResourceReference(DifferentialTablePanel.class, "images/block_show.gif"));
        imageBlockHide = new Image("image_block_hide_diftable", new PackageResourceReference(DifferentialTablePanel.class, "images/block_hide.gif"));
        add(imageBlockShow);
        add(imageBlockHide);
        ...
        final Form form = new Form("differentalForm");
        form.add(treeSimpleTemp);
        form.setOutputMarkupPlaceholderTag(true);

        AjaxLink link = new AjaxLink("differentalLink") {
