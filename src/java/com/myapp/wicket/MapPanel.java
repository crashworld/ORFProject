...
public final class MapPanel extends Panel {
    ...
    public MapPanel(String id) {
        ...
        imageBlockShow = new Image("image_block_show_map", new PackageResourceReference(MapPanel.class, "block_show.gif"));
        imageBlockHide = new Image("image_block_hide_map", new PackageResourceReference(MapPanel.class, "block_hide.gif"));
        add(imageBlockShow);
        add(imageBlockHide);
        ...
        final Image image = new Image("mapData", new PackageResourceReference(MapPanel.class, "map.png"));
        form.add(image);
