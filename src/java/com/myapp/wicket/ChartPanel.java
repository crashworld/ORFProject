...
public final class ChartPanel extends Panel {
    ...
    public ChartPanel(String id) {
        ...
        imageBlockShow = new Image("image_block_show_chart", new PackageResourceReference(ChartPanel.class, "block_show.gif"));
        imageBlockHide = new Image("image_block_hide_chart", new PackageResourceReference(ChartPanel.class, "block_hide.gif"));
        add(imageBlockShow);
        add(imageBlockHide);
        ...
        final Image image = new Image("chartData", new PackageResourceReference(MapPanel.class, "chart.png"));
        form.add(image);
