...
public final class DifferentialTablePanel extends Panel {
    ...
    public DifferentialTablePanel(String id) {
        ...
        imageBlockShow = new Image("image_block_show_diftable", new PackageResourceReference(DifferentialTablePanel.class, "block_show.gif"));
        imageBlockHide = new Image("image_block_hide_diftable", new PackageResourceReference(DifferentialTablePanel.class, "block_hide.gif"));
        add(imageBlockShow);
        add(imageBlockHide);
